...
from preprocess.gov_vehicle_alarm_monthly_preprocess_fatigue_drive_for_lstm import fatigue_drive_data
from data.raw_data import data_dir

save_mode_dir = 'model/fatigue_drive/'
predict_file_path = data_dir + 'fatigue_drive_data_predict.csv'
train = False
